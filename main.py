...
def configure():
    ...
    '''
    return Namespace(resnet_version=2, resnet_size=18, batch_size=128, num_classes=10, save_interval=10, first_num_filters=16, weight_decay=0.0002, modeldir='model_v1')
    ### YOUR CODE HERE
    '''
...
def main(config):
    ...
    ### YOUR CODE HERE
    data_dir = "/content/gdrive/MyDrive/Dibyanshu/ResNet/cifar-10-batches-py/"
    ### YOUR CODE HERE
